        ...
        if(isset($_POST['comEnviar'])) {
            if(!isset($_SESSION['user_rol'])) {
                ...
                if(contar_filas($query) >= 1) {
                    set_mensaje(display_msj("Lo sentimos, solo puede dejar un comentario por producto", "danger"));
                    ...
                    set_mensaje("Comentario realizado, espere a que el admin lo valide");
                    redirect("producto.php?id={$prod_id}");
                }
            }
        }
